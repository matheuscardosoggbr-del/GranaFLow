    ...
    <g filter="url(#sombraObjeto)">
      ...
      <text x="430" y="530" font-family="Arial, sans-serif" font-size="220" font-weight="bold" fill="white" text-anchor="middle">$</text>
            ...
            <div class="auth-body">
                ...
                <form action="<?= BASE_URL ?>auth/cadastro" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="senha" class="form-control" placeholder="Mín. 6 caracteres" minlength="6" required>
                    </div>
                    <div class="mb-4">
                ...
                <div class="text-center mt-4">
                    <span style="color:var(--muted); font-size:13px;">
                        Já tem conta?
                        <a href="<?= BASE_URL ?>auth/login" style="color:var(--accent); font-weight:600; text-decoration:none;">
                            Fazer login
                        </a>
                    </span>
                </div>
