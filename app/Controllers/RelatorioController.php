...
class RelatorioController extends Controller
{
    ...
    public function exportarCSV()
    {
        ...
        foreach ($gastos as $gasto) {
            ...
            $descricao = htmlspecialchars_decode($gasto['descricao']);
            $categoria = htmlspecialchars_decode($gasto['categoria']);
    ...
    public function exportarJSON()
    {
        ...
        $dados = [
            ...
            'salario_mensal' => $salarioModel->getSalario($id_usuario),
            'gastos' => $gastoModel->getGastos($id_usuario),
            'metas' => $metaModel->getMetas($id_usuario),
            'resumo' => [
                'total_gastos' => array_sum(array_column($gastoModel->getGastos($id_usuario), 'valor')),
                'quantidade_gastos' => count($gastoModel->getGastos($id_usuario)),
            ]
        ];
